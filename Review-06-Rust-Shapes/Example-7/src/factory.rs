...
impl Factory {
    ...
    pub fn create(&self, name: &str) -> Option<KnownShape> {
        match name  {
            "Triangle" => Some(KnownShape::Triangle(Default::default())),
            "Right Triangle" => Some(KnownShape::RightTriangle(Default::default())),
            "Equilateral Triangle" => Some(KnownShape::EquilateralTriangle(Default::default())),
            "Square" => Some(KnownShape::Square(Default::default())),
            "Circle" => Some(KnownShape::Circle(Default::default())),
            _ =>  None
        }
    }
