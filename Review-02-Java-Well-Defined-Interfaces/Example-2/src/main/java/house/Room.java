...
public class Room implements Cloneable {
     ...
     * <p>
     * Two Rooms are considered equal if they have matching names and flooring
     * area.
     */
    @Override
    public boolean equals(Object rhs)
    {
        ...
        if (!this.name.equals(rhsRoom.name)) {
            return false;
        }

        // Floating point precision and comparison is discussed in CS 417.
        return this.area() == rhsRoom.area();
    }
