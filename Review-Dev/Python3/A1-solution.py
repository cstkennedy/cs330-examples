...
def main(): 
    ...
    num_1 = int( raw_input( "Enter an Integer: " ) )
    num_2 = int( raw_input( "Enter an Integer: " ) )
    ...
    num_3 = float( raw_input( "Enter a Real Number: " ) )
    num_4 = float( raw_input( "Enter a Real Number: " ) )
    ...
    print ""
    temp_f = float( raw_input("Enter a Temperature (F): ") )
