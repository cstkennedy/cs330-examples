...
def main(): 
    ...
    num_1 = int( eval(input( "Enter an Integer: " )) )
    num_2 = int( eval(input( "Enter an Integer: " )) )
    ...
    num_3 = float( eval(input( "Enter a Real Number: " )) )
    num_4 = float( eval(input( "Enter a Real Number: " )) )
    ...
    print("")
    temp_f = float( eval(input("Enter a Temperature (F): ")) )
    ...
    print(("{:<18}: {:>20.2f}".format("Farenheit",  temp_k)))
