...
public class Room implements Cloneable {
    ...
    /**
     * Flooring Record for a Room. Note that this data-type is meaningless
     * outside the context of of Room ADT for this scenario.
     */
    public class Flooring {
        ...
        /**
         * Default to "Generic" for the type and 1.00 for the cost.
         */
        public Flooring()
        {
            this("Generic", 1.0);
    ...
    public static class DimensionSet {
        ...
        /**
         * Set the length and width to user specified values.
         */
