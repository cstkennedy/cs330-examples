...
public class Board
{
    ...
    public String toString()
    {
        return String.join(
            ...
            String.format("%s|%s|%s%n", this.theBoard[0], this.theBoard[1], this.theBoard[2]),
            String.format("%s|%s|%s%n", this.theBoard[3], this.theBoard[4], this.theBoard[5]),
            String.format("%s|%s|%s%n", this.theBoard[6], this.theBoard[7], this.theBoard[8])
        );
    }
}
